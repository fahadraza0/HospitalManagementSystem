        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TreatmentRecords_Billings_BillId",
                        column: x => x.BillId,
                        principalTable: "Billings",
                        principalColumn: "BillingId");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TreatmentMedicines_Billings_BillingId",
                        column: x => x.BillingId,
                        principalTable: "Billings",
                        principalColumn: "BillingId");
                    table.ForeignKey(
                        name: "FK_TreatmentMedicines_Doctors_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "Doctors",
                        principalColumn: "DoctorId");
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_TreatmentMedicines_TreatmentRecords_TreatmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TreatmentMedicines_BillingId",
                table: "TreatmentMedicines",
                column: "BillingId");

            migrationBuilder.CreateIndex(
                name: "IX_TreatmentMedicines_DoctorId",
                table: "TreatmentMedicines",
                column: "DoctorId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TreatmentRecords_BillId",
